	...
	ondrop: function (event) {
        ...
        function Add() {
            ...
            if (task) {
                ...
                // el2 = '';
                tasks.push(task);
                // console.log(tasks[0].one);
                // console.log(tasks[0].two);
...
function fnSetPlayer() {
	...
	if (totalItems == 1) {
		$('.navigationControls, .nextBtn, .showAnsBtn, .backBtn, .pageNumber').addClass('hide');
	}
